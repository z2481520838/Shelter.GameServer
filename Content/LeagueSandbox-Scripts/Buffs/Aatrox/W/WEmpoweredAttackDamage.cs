...
namespace AatroxWONHPowerBuff
{
    ...
    class AatroxWONHPowerBuff : IBuffGameScript
    {
        ...
        public void OnPreAttack(ISpell spell)
        {
            ...
            //{
             //   SpellCast(owner, 4, SpellSlotType.ExtraSlots, false, spell.CastInfo.Owner.TargetUnit, Vector2.Zero);
             //   Buff.DeactivateBuff();
        ...
        {
            //if (Unit != null && Unit.HasBuff("AatroxWONHLifeBuff"))
            //{
                //RemoveBuff(Unit, "AatroxWLife");
